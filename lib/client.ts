...
export function Environment(name: string): BaseURL {
  return `https://${name}-website-info-api-mxa2.encr.app`;
}
...
/**
 * Client is an API client for the website-info-api-mxa2 Encore application.
 */
...
export namespace website {
  /**
   * URLInfoRequest represents the request for getting URL information
   */
  ...
  /**
   * URLInfoResponse represents the response with URL information
   */
  ...
  export class ServiceClient {
    ...
    public async GetURLInfo(params: URLInfoRequest): Promise<URLInfoResponse> {
      ...
      return (await resp.json()) as URLInfoResponse;
    }
  }
}
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (!BROWSER) {
      this.headers["User-Agent"] =
        "website-info-api-mxa2-Generated-TS-Client (Encore/v1.48.12)";
    }
